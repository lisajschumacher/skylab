...
class ExtendedSourceLLH(PointSourceLLH):
    r"""Basic Point Source Likelihood class
    ...
    _src_ra = _src_ra
    _src_dec = _src_dec
    _src_sigma = _src_sigma

    def __init__(self, exp, mc, livetime,
                 scramble=True, upscale=False, **kwargs):
        r"""Constructor of `ExtendedSourceLikelihood`.
        ...
        """
        super(ExtendedSourceLLH, self).__init__(exp, mc, livetime,
                 scramble=True, upscale=False, **kwargs)
    ...
    def _select_events(self, src_ra, src_dec, **kwargs):
        ...
        src_sigma : float, array_like
            Spread (assumed Gaussian) of the source(s)
        ...
        # calculate signal term
        self._ev_S = self.llh_model.signal(src_ra, src_dec, self._ev, src_sigma)
